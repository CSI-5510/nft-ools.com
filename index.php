          ...
          <header class="flex flex-col sm:flex-row items-center justify-between py-6 relative">
            ...
            <div class="absolute right-40 top-25 h-60 w-100">
              <nav class="hidden md:flex text-lg">
                  <a href="#" class="text-white hover:text-purple-400 py-3 px-6">Home</a>
                  <a href="#" class="text-white hover:text-purple-400 py-3 px-6">About Us</a>
                  <a href="#" class="text-white hover:text-purple-400 py-3 px-6 ">Login/ Register</a>
              </nav>
            </div>

    ...
    <div class="flex pb-10">
        <div class="ml-10">
            ...
            <div class="flex items-right">
                <a class="text-right cursor-pointer h-10 px-7 ml-50 focus:outline-none hover:border-transparent text-center rounded border border-gray-400 hover:bg-blue-500 hover:text-white bg-transparent text-gray-500 font-semibold">Edit Profile</a>
            </div>
            <div class="">

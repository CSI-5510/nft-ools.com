                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                <input type="text" name="address2" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="123 sesame street" value="<?php echo $address2;?>">
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-location-enter text-gray-400 text-lg"></i></div>
                                <input type="phone" name="phone" id="pac-input" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="1234554656" value="<?php echo $phone;?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex -mx-3">
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-gender-male-female-variant text-gray-400 text-lg"></i></div>
                                <input type="text" name="state" id="pac-input" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Texas" value="<?php echo $state;?>">
                            </div>
                        </div>

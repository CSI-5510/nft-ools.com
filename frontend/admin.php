...
if ($isListingApproved) {
    //console("success");
    echo '<div class="alert alert-success" role="alert">Item approval status was successfully updated! '.var_dump($msg).'<br><a href="../frontend/admin.php">Return to NFT-ools Admin</a>';
} else {
    //console("failure");

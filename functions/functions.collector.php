<?php 
    ...
    function drawCollectorAddItem(){
        // ROW 1
        echo '<form method="POST" action="/'.$GLOBALS["url_loc"][0].'/collector/add_item_confirmation" enctype="multipart/form-data"><div class="'.FLEX_ROW_NO_JUSTIFY.'">';
        drawLabel("PRICE", LISTING_LABEL);
        echo '</div>';
        // ROW 2
        echo '<div class="'.FLEX_ROW_NO_JUSTIFY.'">';
